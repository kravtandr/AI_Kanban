    ...
    <>
      ...
      {form && draft && (
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/40 p-0 md:items-center md:p-4">
          <div className="max-h-[92vh] w-full overflow-y-auto rounded-t-2xl bg-white p-5 md:max-w-lg md:rounded-2xl dark:bg-slate-900">
            ...
            <TaskForm values={form} projects={projects} onChange={setForm} />
